...
import frc.robot.limelightvision.ControlMode.Advanced_Crosshair;
import frc.robot.limelightvision.ControlMode.Advanced_Target;
import frc.robot.limelightvision.ControlMode.CamMode;
import frc.robot.limelightvision.ControlMode.LedMode;
import frc.robot.limelightvision.ControlMode.Snapshot;
import frc.robot.limelightvision.ControlMode.StreamType;
